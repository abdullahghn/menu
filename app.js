...
/* WORKING CODE - MY SOLUTION
const uniqueCategories = [...new Set(menu.map(item => item.category))];
let btns  = '<button class="filter-btn" type="button" data-category="all">all</button>';

for(let i = 0; i < uniqueCategories.length; i++) {  
  btns += `<button class="filter-btn" type="button" data-category="${uniqueCategories[i]}">${uniqueCategories[i]}</button>`;
